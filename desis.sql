...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2024 a las 16:59:13
...
(5, 'Nicolas Yañez', 'Partido del Discord'),
(6, 'Francisco Mella', 'Partido de Facturaci');
...
(12, 'nicolas wonka', 'nicks', '19171718-K', 'prueba@prueba.cl', 2, 7, 5, 0);
...
--
ALTER TABLE `candidato`
  MODIFY `id_candidato` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
